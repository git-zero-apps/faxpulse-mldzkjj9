  ...
  return (
    <div className="max-w-2xl">
      ...
      <form onSubmit={handleSubmit} className="card space-y-6">
        ...
        <div>
          <label htmlFor="monthly_cost" className="label">Monthly Cost</label>
          <input id="monthly_cost" name="monthly_cost" type="number" className="input" defaultValue={String(record.monthly_cost ?? "")} step="0.01" />
        </div>
