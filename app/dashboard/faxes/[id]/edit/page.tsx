    ...
    <div className="max-w-2xl">
      ...
      <form onSubmit={handleSubmit} className="card space-y-6">
        ...
        <div>
          ...
          <input id="to_number" name="to_number" type="text" className="input" defaultValue={String(record.to_number ?? "")} required />
        </div>
        <div>
          <label htmlFor="from_number" className="label">From Number</label>
          <input id="from_number" name="from_number" type="text" className="input" defaultValue={String(record.from_number ?? "")} required />
        </div>
        <div>
