    ...
    <div className="bg-[#0a0a0f] text-gray-100 min-h-screen relative">
      ...
      <section className="relative mx-auto max-w-4xl px-6 pt-24 pb-32 text-center">
        ...
        <p className="animate-fade-up [animation-delay:350ms] mt-6 text-lg text-gray-400 sm:text-xl max-w-2xl mx-auto leading-relaxed">
          Modern online fax service without the hardware
        </p>
      ...
      <section id="features" className="bg-[#0a0a0f] py-24">
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            ...
            <h3 className="text-lg font-semibold text-white">send-fax-by-upload</h3>
            <p className="mt-2 text-sm text-gray-400">Manage your send-fax-by-upload with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
          ...
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            ...
            <p className="mt-2 text-sm text-gray-400">Manage your subscription-plans with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <p className="mt-2 text-sm text-gray-400">Manage your team-members with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <h3 className="text-lg font-semibold text-white">fax-number-provisioning</h3>
            <p className="mt-2 text-sm text-gray-400">Manage your fax-number-provisioning with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <p className="mt-2 text-sm text-gray-400">Manage your usage-limits with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <p className="mt-2 text-sm text-gray-400">Manage your billing-management with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <h3 className="text-lg font-semibold text-white">fax-history</h3>
            <p className="mt-2 text-sm text-gray-400">Manage your fax-history with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <p className="mt-2 text-sm text-gray-400">Manage your document-preview with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <h3 className="text-lg font-semibold text-white">resend-failed-fax</h3>
            <p className="mt-2 text-sm text-gray-400">Manage your resend-failed-fax with ease using our intuitive interface.</p>
          </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24">
        <div className="mx-auto max-w-3xl px-6 text-center">
          ...
          <p className="mt-4 text-lg text-gray-400 max-w-xl mx-auto">
            Join thousands of teams who use FaxPulse to work smarter.
          </p>
          <div className="mt-10">
            <Link
              href="/login"
